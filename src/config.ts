...
export const siteConfig: SiteConfig = {
	title: "my blog",
	subtitle: "listen to my insane thoughts",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "Main Site",
			url: "https://caitlyn.moe", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			...
			url: "https://steamcommunity.com/profiles/76561198787864710",
		},
		{
			name: "AniList",
